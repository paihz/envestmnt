                    ...
                    <div class="panel-body">
                        <form  role="form" method="POST" action="{{ url('/register') }}">
                            ...
                            <div class="form-group">
                                <input type="text" name="name" required value="{{ old('name') }}" placeholder="Full name" autocomplete="off"
                                       class="form-control">
                                @if ($errors->has('name'))
                            ...
                            <div class="form-group">
                                <input type="email" name="email" value="{{ old('email') }}" required placeholder="E-mail" autocomplete="off"
                                       class="form-control">
                                @if ($errors->has('email'))
                                    <span class="text-danger">
                            ...
                            <div class="form-group">
                                <div data-min-view="2" data-date-format="yyyy-mm-dd" class="input-group date datetimepicker">
                                    <input size="16" placeholder="Your birthday" name="birthday" type="text"  class="form-control"><span class="input-group-addon btn btn-primary"><i class="icon-th mdi mdi-calendar"></i></span>
                            ...
                            <div class="form-group xs-pt-10">
                                <button type="submit" class="btn btn-block btn-primary btn-xl">Create new account</button>
                            </div>
                            <div class="form-group xs-pt-10">
